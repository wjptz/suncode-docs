...
| **Command**   | `/trellis:continue`    | Manual                                                     | Advance the current task to its next step — you don't memorize the workflow (see §1.2.4) |
...
#### 1.2.3 `/trellis:start`: Start a session
...
#### 1.2.4 `/trellis:finish-work`: Wrap up + archive
...
#### 1.2.5 `/trellis:continue`: Advance within the current task
