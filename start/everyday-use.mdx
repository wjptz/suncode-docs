...
#### Seeded on Create, AI Curates in Phase 1.3
...
This is self-describing — the seed line is ignored by all consumers (hook, prelude, validate, list-context) because it has no `file` field. The AI reads it, then fills in real entries during Phase 1.3.
