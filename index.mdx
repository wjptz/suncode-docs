...
Supported platforms: Claude Code, Cursor, OpenCode, Engineer, Codex, Kiro, Kilo, Gemini CLI, Antigravity, Devin, Qoder, CodeBuddy, GitHub Copilot, Droid, Pi Agent, Oh My Pi, Reasonix, ZCode, Trae, Grok Build, and Kimi Code, plus any agent that reads the `.agents/skills/` standard (Amp, Cline, Deep Agents, Firebender, Warp, and more).
