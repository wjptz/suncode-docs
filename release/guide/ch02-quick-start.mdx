...
<Tabs>
  ...
  <Tab title="CodeBuddy">
    ```bash trellis init --codebuddy -u your-name ``` Configures `.codebuddy/commands/trellis/`
    directory (slash commands with nested namespacing).
  </Tab>
</Tabs>
...
| Capability               |     Claude Code      |      Cursor      |    Codex     | OpenCode |            Kilo            |        Kiro         |         CodeBuddy          |
| ------------------------ | :------------------: | :--------------: | :----------: | :------: | :------------------------: | :-----------------: | :------------------------: |
| Session auto-injection   |       ✅ Hook        | ❌ Manual /start | ⚡ AGENTS.md | ✅ Hook  |  ⚡ rules/ + launchConfig  |    ⚡ steering/     | ❌ Manual /trellis:start   |
...
| Number of commands       |          13          |        12        |      13      |    13    |         workflows          |       prompts       |             12             |
...
# AI reads specs → creates task → implements → manually run /trellis:check to check
...
└── .codebuddy/                        # CodeBuddy configuration
    └── commands/
        └── trellis/                   #   Trellis command set (nested)
            ├── start.md
            ├── check.md
            └── ...
```
