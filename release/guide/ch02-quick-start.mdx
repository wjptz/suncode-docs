...
<Tabs>
  ...
  <Tab title="Qoder">
    `trellis init --qoder -u your-name` — writes `.qoder/skills/trellis-{name}/SKILL.md` (auto-trigger skills) + `.qoder/rules/trellis.md`.
  </Tab>
...
| **Qoder**           | `.qoder/skills/`, `.qoder/rules/`                                         | skill auto-match |
