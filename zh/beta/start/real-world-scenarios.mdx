...
| 阶段 | 目标             | 退出标准                                                                                                                                                                                                                                        |
| ---- | ---------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| 1    | 试点一个仓库     | 用 specs、checks、journal 完成一个真实任务。spec 起点两个选项：从 [spec template marketplace](/zh/start/install-and-first-task#官方-marketplace) 拉一个匹配技术栈的 spec 包；或用 `cc-codex-spec-bootstrap` 让 CC + Codex 从代码生成第一版 spec |
