---
title: 'Devin setup'
description: 'Configure Devin for your documentation workflow'
icon: 'water'
---

<Note>Devin was formerly known as Windsurf.</Note>

Configure Devin's AI assistant to help you write and maintain documentation. This guide shows how to set up Devin specifically for your Mintlify documentation workflow.
...
Create workspace rules that provide Devin with context about your documentation project and standards.

Create `.devin/rules.md` in your project root:
