...
3. 可选：使用 Trellis 内置安装的 `trellis-spec-bootstarp`，从真实代码生成第一版 spec；其它对当前技术栈有用的 skills 可以一起接入。
...
3. 可选：使用 Trellis 内置安装的 `trellis-spec-bootstarp`，让 AI 从真实代码生成第一版 spec，再人工 review。
