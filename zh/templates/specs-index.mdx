...
<Tip>
不需要一次填完所有 spec 文件。先从对你项目最重要的部分开始，然后逐步扩展。`/trellis:start` 的 bootstrap 任务会引导你完成初始填写。
</Tip>

## 贡献模板

想和社区分享你的 spec？创建一个包含模板的仓库，然后提 PR 将它添加到[官方模板仓库](https://github.com/mindfold-ai/docs/tree/main/marketplace)。
