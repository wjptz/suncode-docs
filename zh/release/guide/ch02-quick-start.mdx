...
<Tabs>
  ...
  <Tab title="Qoder">
    `trellis init --qoder -u your-name` —— 写入 `.qoder/skills/trellis-{name}/SKILL.md`（auto-trigger skill）+ `.qoder/rules/trellis.md`。
  </Tab>
...
| **Qoder**           | `.qoder/skills/`、`.qoder/rules/`                                         | skill 自动匹配   |
...
| 能力                 | Claude Code | Cursor | OpenCode | Codex   | iFlow | Gemini | Kilo | Kiro | Qoder | Copilot | Windsurf | Droid |
| -------------------- | :---------: | :----: | :------: | :-----: | :---: | :----: | :--: | :--: | :---: | :-----: | :------: | :---: |
| 会话自动注入         | ✅ Hook     | ❌     | ✅ Hook  | ⚡ 可选 | ✅ Hook | ❌   | ⚡   | ⚡   | ⚡    | ⚡      | ⚡       | ✅ Hook |
| 子 Agent 规范注入    | ✅          | ❌     | ✅       | ⚡      | ✅    | ❌     | ❌   | ⚡   | ❌    | ❌      | ❌       | ✅    |
| Ralph Loop 质量门    | ✅          | ❌     | ⚡       | ❌      | ✅    | ❌     | ❌   | ⚡   | ❌    | ❌      | ❌       | ⚡    |
| Multi-Agent Pipeline | ✅          | ❌     | ✅       | ❌      | ❌    | ❌     | ✅   | ✅   | ❌    | ❌      | ❌       | ❌    |

图例：✅ 完整 / ⚡ 部分（通过手动调用或 opt-in 平台 flag）/ ❌ 不支持。
...
<Note>
  上面 Tab 展示的是最常用平台。Gemini CLI、iFlow、Qoder、GitHub Copilot、Windsurf、Factory Droid 安装后工作流跟 Claude Code 一致——详见第 13 章各平台章节。
</Note>
