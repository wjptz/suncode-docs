---
title: 'Understanding Trellis Through Kubernetes'
---
...
<Note>
  This article was written in the Trellis 0.4.x era. Some named concepts have changed since: the Ralph Loop, `dispatch` / `plan` / `debug` agents, and the Multi-Agent Pipeline were all removed in 0.5.0-beta.0. The high-level K8s analogy still applies; read specific agent / hook names here as historical references.
</Note>
