...
3. Optional: install the bundled marketplace skill `trellis-spec-bootstarp` so AI can draft first-pass specs from the real codebase. Install with `npx skills add mindfold-ai/marketplace --skill trellis-spec-bootstarp`.
