---
title: 'Contributing'
description: 'How to contribute to Trellis documentation'
---
...
Made a useful spec template or skill? Add it to the marketplace:

1. Fork the repo
2. Add your template to `marketplace/specs/` or `marketplace/skills/`
3. Create documentation pages (both EN and ZH)
