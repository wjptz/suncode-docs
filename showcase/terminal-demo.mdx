...
<Steps>
  <Step title="Start session">
    SessionStart hook or extension loads your project context: workflow rules, active tasks, git status, and recent journal entries. The AI is immediately oriented.
  </Step>
  ...
  <Step title="Update specs">
    The `trellis-update-spec` skill captures new patterns learned from this session into the spec library: making future sessions even better.
  </Step>
