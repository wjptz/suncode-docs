  ...
  <div className="td-inner">
    ...
    <div className="td-window">
      ...
      <div className="td-body">
        ...
        <div className="td-line td-line-sub td-d14">
          └ Found 1 issue → fixed automatically <span className="td-success">✓</span>
        </div>
        ...
        <div className="td-line td-line-ai td-d16">
          <span className="td-bullet">● </span>
          Added Gemini CLI conventions to <span className="td-link">platform-integration.md</span>
        </div>

        {/* ── Phase 8: Record session ── */}
        <div className="td-line td-line-user td-d17">
          <span className="td-prompt">❯ </span>
          <span className="td-cmd">/trellis:record-session</span>
        </div>
        <div className="td-line td-line-ai td-d18">
          <span className="td-bullet">● </span>
          Session archived. 5 commits on <span className="td-link">feat/gemini</span>. Ready for review.
        </div>
    ...
    <div className="td-descs">
      ...
      <div className="td-desc td-desc-2">
        ...
        <p className="td-desc-text">Research Agent finds relevant specs and code patterns. Context files configured in jsonl — hooks auto-inject them into agents.</p>
      </div>
      ...
      <div className="td-desc td-desc-4">
        ...
        <p className="td-desc-text">Check Agent reviews every changed file against code-specs. Issues found and fixed automatically.</p>
      </div>
