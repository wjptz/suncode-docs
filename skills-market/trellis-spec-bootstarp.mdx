...
The beta bundle includes this skill. The docs also mention it on the release track so the same workflow is visible there once the release bundle includes the matching skill.
