...
| [trellis-spec-bootstarp](/skills-market/trellis-spec-bootstarp)                   | Bootstrap project-specific Trellis specs from the real codebase                 | `npx skills add mindfold-ai/marketplace -s trellis-spec-bootstarp`          |
