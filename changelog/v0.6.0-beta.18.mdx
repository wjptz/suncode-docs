...
The marketplace beta bundle now includes `trellis-spec-bootstarp`, a platform-neutral skill for bootstrapping `.trellis/spec/` from the real codebase.
...
- Installs with `npx skills add mindfold-ai/marketplace --skill trellis-spec-bootstarp`
