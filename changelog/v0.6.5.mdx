...
The bundled workflow now routes Trae implement dispatch through the class-2 pull-based block, not the hook auto-handles block. This keeps the generated workflow aligned with Trae's pull-based sub-agent definitions.
