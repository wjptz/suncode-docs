...
ZCode command fallbacks now stay under `.zcode/commands/trellis/` instead of the shared `.agents/skills/` directory. This prevents Codex + ZCode combined installs from reporting immediate template drift on `trellis update --dry-run`.
