...
### Q2: How do I develop in parallel?

Open multiple sessions on separate branches. Most modern agent CLIs and IDEs now have native worktree support — use that for isolation. Trellis's older `/parallel` pipeline and `worktree.yaml` were removed in 0.5 because native tooling is better.
