...
### 8.2 Changing the per-turn breadcrumbs
...
### 8.3 Adding a custom workflow state
...
### 8.4 Changing the skill routing table
...
Add a row for a custom skill you shipped (see [Chapter 12: Custom Skills](./ch12-custom-skills)):
...
### 8.5 Adding or reshaping a Phase
...
### 8.7 When your change takes effect
