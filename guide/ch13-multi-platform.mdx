...
### 13.1 Joining an Already-Initialized Trellis Project
...
Qoder does support Custom Commands (typed with `/` in the agent input, stored under `~/.qoder/commands/` or `<project>/.qoder/commands/`), but Trellis's design choice is to deliver everything as auto-trigger skills on Qoder, leaving `.qoder/commands/` free for your own custom commands.
...
### 13.13 Other supported platforms
...
### 13.15 Multi-Developer Collaboration
...
### 13.16 `trellis update` and Version Management
