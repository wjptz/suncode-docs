...
```bash
npx @mindfold-ai/trellis update
```

Updates CLI, migrates file formats. Specs and custom commands preserved. Hook scripts might need review if new version changes them.
