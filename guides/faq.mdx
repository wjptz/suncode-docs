...
**Hooks**: Cursor now supports hooks natively, but Trellis hasn't implemented Cursor hook support yet (planned for future). For now, you'll need to manually reference spec files at session start.

Multi-agent workflows also don't work in Cursor yet.
